...
insert into gerenciar_controle_ifto_papel_pessoa(descricao,vinculado_corRfid) VALUES("Aluno",False);
insert into gerenciar_controle_ifto_papel_pessoa(descricao,vinculado_corRfid) VALUES("Professor",False);
insert into gerenciar_controle_ifto_papel_pessoa(descricao,vinculado_corRfid) VALUES("Visitante",False);
...
insert into gerenciar_controle_ifto_rfid(tag_rfid_value,data_cadastro, cod_corRFID_funcao_id, vinculado, ativo) VALUES("73 95 CC 13", now(),3,0,1);
...
insert into gerenciar_controle_ifto_pessoa(nome,sobrenome,cpf,idade,data_nascimento,vinculado,cod_Papel_pessoa_id,cod_Rfid_id) values("Israel","Clementino","194.674.281-30",30,"1994-05-30",1,2,3);
